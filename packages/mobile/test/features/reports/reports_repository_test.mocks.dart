...
class MockRecordDao extends _i1.Mock implements _i6.RecordDao {
  ...
  @override
  _i2.$RecordsTable get records => (super.noSuchMethod(
  ...
  @override
  _i5.Stream<List<_i2.Record>> watchRecords({
    int? limit,
    int? offset,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<List<_i2.Record>> getAllRecords({
    int? limit,
    int? offset,
  }) =>
      (super.noSuchMethod(
  ...
  _i5.Future<List<_i2.Record>> getRecordsByCategoryAndDateRange(
    ...
    DateTime? end,
      ...
      (super.noSuchMethod(
        Invocation.method(
          #getRecordsByCategoryAndDateRange,
          [
            categoryId,
            start,
            end,
  ...
  @override
  _i5.Future<double> getTotalSpending(
    DateTime? start,
    DateTime? end,
  ) =>
      (super.noSuchMethod(
