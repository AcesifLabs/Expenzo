...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget _buildAvatarWidget(
    ...
    if (photoUrl != null) {
      ...
      avatarChild = Icon(PiconsRegular.user, color: primaryColor, size: 20);
    }
  ...
  List<Widget> _buildLoadedContent(
    ...
    return [
      ...
      _buildRecentTransactionsSection(s.recentTransactions, currencyFmt),
    ];
  }
  ...
  Widget _buildBudgetSkeleton(BuildContext context) {
    ...
    final shimmerRect = ShimmerBox.rectangle(width: double.infinity, height: 8);
  ...
  Widget _buildBalanceSkeleton() {
    final shimmerBtn = ShimmerBox.rectangle(
      width: 80,
      height: 36,
      borderRadius: 8,
    );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Spacer(),
              Row(
                children: [shimmerBtn, const SizedBox(width: 24), shimmerBtn],
              ),
            ],
          ),
        ),
