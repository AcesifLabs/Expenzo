...
class _AppState extends State<App> {
  ...
  Future<void> _initSettingsWhenReady() async {
    ...
    _settingsSubscription = bloc.stream.listen(_onSettingsState);
  }

  void _onSettingsState(SettingsState state) {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<ThemeMode>(
      ...
      builder: (context, themeMode, child) => _buildMaterialApp(themeMode),
    );
  }
}
